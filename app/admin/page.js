...
export default function AdminPanel() {
  ...
  const brand = {
    ...
    danger: '#DC2626', success: '#059669', gold: '#6366F1',
  };

  const tabIcons = {
    bookings: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>,
    ...
    frequencies: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="23 4 23 10 17 10"/><polyline points="1 20 1 14 7 14"/><path d="M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15"/></svg>,
    neighborhoods: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>,
    buildings: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"/><line x1="9" y1="6" x2="9" y2="6.01"/><line x1="15" y1="6" x2="15" y2="6.01"/><line x1="9" y1="10" x2="9" y2="10.01"/><line x1="15" y1="10" x2="15" y2="10.01"/><line x1="9" y1="14" x2="9" y2="14.01"/><line x1="15" y1="14" x2="15" y2="14.01"/><line x1="9" y1="18" x2="15" y2="18"/></svg>,
    floorplans: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="9" y1="21" x2="9" y2="9"/></svg>,
    unitlines: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="8" y1="6" x2="21" y2="6"/><line x1="8" y1="12" x2="21" y2="12"/><line x1="8" y1="18" x2="21" y2="18"/><line x1="3" y1="6" x2="3.01" y2="6"/><line x1="3" y1="12" x2="3.01" y2="12"/><line x1="3" y1="18" x2="3.01" y2="18"/></svg>,
    addons: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><line x1="12" y1="8" x2="12" y2="16"/><line x1="8" y1="12" x2="16" y2="12"/></svg>,
    workers: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>,
  ...
  const buttonStyle = { padding: '7px 14px', fontSize: 13, fontWeight: 600, border: 'none', borderRadius: 8, cursor: 'pointer', transition: 'all 150ms ease', display: 'inline-flex', alignItems: 'center', gap: 6 };
  const inputStyle = { padding: '9px 12px', fontSize: 13, border: '1px solid #E5E7EB', borderRadius: 8, width: '100%', boxSizing: 'border-box', outline: 'none', fontFamily: "'Inter', -apple-system, BlinkMacSystemFont, sans-serif", background: '#fff', transition: 'border-color 150ms, box-shadow 150ms' };
  ...
  if (authLoading || dataLoading) {
    return <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#fff' }}><div style={{ textAlign: 'center' }}><div style={{ width: 40, height: 40, border: '3px solid #E5E7EB', borderTopColor: '#6366F1', borderRadius: '50%', animation: 'spin 0.8s linear infinite', margin: '0 auto 16px' }} /><p style={{ color: '#6B7280', fontSize: 15 }}>Loading...</p></div><style jsx global>{`@keyframes spin { to { transform: rotate(360deg); } }`}</style></div>;
  }

  return (
    <div style={{ minHeight: '100vh', background: '#fff', fontFamily: "'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
      <header className="admin-header" style={{ padding: '14px 24px', background: '#fff', borderBottom: '1px solid #E5E7EB', boxShadow: '0 1px 3px rgba(0,0,0,0.05)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', position: 'sticky', top: 0, zIndex: 100 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          <Logo />
          <span style={{ fontSize: 18, fontWeight: 700, color: '#111827', letterSpacing: '-0.02em' }}>BetterView</span>
          <span style={{ marginLeft: 8, padding: '4px 10px', background: '#6366F1', color: '#fff', borderRadius: 6, fontSize: 11, fontWeight: 700, letterSpacing: '0.04em' }}>ADMIN</span>
        </div>
        <div className="admin-header-right" style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          <Link href="/admin/calendar" style={{ fontSize: 14, color: '#6366F1', textDecoration: 'none', fontWeight: 600, padding: '8px 20px', background: '#EEF2FF', borderRadius: 100, transition: 'background 0.15s' }}>
            Calendar View
          </Link>
          <span style={{ fontSize: 13, color: '#6B7280' }}>{user?.email}</span>
          <button onClick={handleLogout} style={{ ...buttonStyle, background: '#EEF2FF', color: '#111827' }}>Log Out</button>
        </div>
        ...
        <div className={`mobile-menu ${mobileMenuOpen ? 'open' : ''}`}>
          <Link href="/admin/calendar" onClick={() => setMobileMenuOpen(false)} style={{ padding: '16px', fontSize: 16, fontWeight: 600, color: '#fff', textDecoration: 'none', textAlign: 'center', borderRadius: 12, background: '#6366F1' }}>
            Calendar View
          </Link>
          <span style={{ padding: '14px 16px', fontSize: 13, color: '#6B7280', textAlign: 'center' }}>{user?.email}</span>
          <button onClick={() => { handleLogout(); setMobileMenuOpen(false); }} style={{ padding: '16px', fontSize: 16, fontWeight: 600, background: '#EEF2FF', border: 'none', borderRadius: 12, color: '#111827', cursor: 'pointer' }}>
            Log Out
          </button>
        </div>
      </header>
      ...
      <div className="admin-layout" style={{ display: 'flex' }}>
        <aside className="admin-sidebar" style={{ width: 220, background: '#fff', borderRight: '1px solid #E5E7EB', minHeight: 'calc(100vh - 57px)', padding: '12px 8px', position: 'sticky', top: 57, alignSelf: 'flex-start' }}>
          {tabs.map(tab => (
            <button key={tab.id} onClick={() => setActiveTab(tab.id)} style={{
              display: 'flex', alignItems: 'center', gap: 10, width: '100%',
              padding: '9px 12px', textAlign: 'left',
              background: activeTab === tab.id ? '#EEF2FF' : 'transparent', border: 'none',
              borderRadius: 8,
              ...
              <span style={{ width: 20, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, opacity: activeTab === tab.id ? 1 : 0.5 }}>{tabIcons[tab.id]}</span>
              {tab.label}
            </button>
          ))}
        </aside>

        <main className="admin-main" style={{ flex: 1, padding: 28, background: '#F9FAFB' }}>
          ...
          {activeTab === 'bookings' && (
            <div>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24, flexWrap: 'wrap', gap: 12 }}>
                <h1 style={{ fontSize: 24, fontWeight: 800, color: '#111827', letterSpacing: '-0.02em' }}>Bookings</h1>
              ...
              <div className="table-wrapper">
                <div style={{ background: '#fff', borderRadius: 12, border: '1px solid #E5E7EB', overflow: 'hidden', minWidth: 800 }}>
                          ...
                          <tr key={booking.id} style={{ borderTop: `1px solid ${brand.border}` }}>
                            ...
                            <td style={{ padding: '16px', textAlign: 'right' }}>
                              <div style={{ display: 'flex', gap: 6, justifyContent: 'flex-end', flexWrap: 'wrap' }}>
                                {isActionable && (
                                  <>
                                    <button onClick={() => handleMarkComplete(booking.id)} style={{ ...buttonStyle, background: '#6366F1', color: '#fff', fontSize: 12, padding: '6px 12px' }}>
                                      Complete
                                    </button>
          ...
          {activeTab === 'customers' && (() => {
            ...
            return (
              <div>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24, flexWrap: 'wrap', gap: 12 }}>
                  <div>
                    <h1 style={{ fontSize: 24, fontWeight: 800, color: '#111827', letterSpacing: '-0.02em' }}>Customers</h1>
                ...
                <div className="table-wrapper">
                  <div style={{ background: '#fff', borderRadius: 16, border: '1px solid #E5E7EB', overflow: 'hidden', minWidth: 700 }}>
                    <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                      <thead>
                        <tr style={{ background: '#F9FAFB' }}>
                                ...
                                <tr>
                                  <td colSpan={6} style={{ padding: 0 }}>
                                    <div style={{ padding: '0 16px 16px 48px', background: brand.bg }}>
                                      ...
                                      <div style={{ background: '#fff', borderRadius: 16, border: '1px solid #E5E7EB', padding: 16, marginBottom: 16, marginTop: 8 }}>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
                                          <p style={{ fontSize: 14, fontWeight: 600, color: brand.text }}>Customer Info</p>
                                          {editingCustomerEmail === c.email ? (
                                            <div style={{ display: 'flex', gap: 6 }}>
                                              <button onClick={() => handleSaveCustomerInfo(c.email, c.bookings, c.user_id)} style={{ ...buttonStyle, background: '#6366F1', color: '#fff', fontSize: 12, padding: '6px 12px' }}>Save</button>
                                              <button onClick={() => { setEditingCustomerEmail(null); setEditingCustomerValue({}); }} style={{ ...buttonStyle, background: '#EEF2FF', color: '#111827', fontSize: 12, padding: '6px 14px' }}>Cancel</button>
                                            </div>
                                          ) : (
                                            <button onClick={() => { setEditingCustomerEmail(c.email); setEditingCustomerValue({ customer_name: c.name || '', customer_email: c.email, phone: c.phone || '' }); }} style={{ ...buttonStyle, background: '#EEF2FF', color: '#111827', fontSize: 12, padding: '6px 14px' }}>Edit</button>
                                          )}
                                        </div>
                                                  ...
                                                  <tr key={b.id} style={{ borderTop: `1px solid ${brand.border}` }}>
                                                    ...
                                                    <td style={{ padding: '10px 12px', textAlign: 'right' }}>
                                                      <div style={{ display: 'flex', gap: 4, justifyContent: 'flex-end', flexWrap: 'wrap' }}>
                                                        {isEditing ? (
                                                          <>
                                                            <button onClick={() => handleSaveBookingEdit(b.id)} style={{ ...buttonStyle, background: '#6366F1', color: '#fff', fontSize: 11, padding: '5px 10px' }}>Save</button>
                                                          ...
                                                          <>
                                                            <button onClick={(e) => { e.stopPropagation(); setEditingBookingId(b.id); setEditingBookingValue({ booking_date: b.booking_date, booking_time: b.booking_time || '', worker_id: b.worker_id || '', unit_number: b.unit_number || '', special_instructions: b.special_instructions || '' }); }} style={{ ...buttonStyle, background: '#EEF2FF', color: '#111827', fontSize: 11, padding: '5px 10px' }}>Edit</button>
                                                            {isActionable && (
                                                              <>
                                                                <button onClick={(e) => { e.stopPropagation(); handleMarkComplete(b.id); }} style={{ ...buttonStyle, background: '#6366F1', color: '#fff', fontSize: 11, padding: '5px 10px' }}>Complete</button>
          ...
          {activeTab === 'frequencies' && (
            <div>
              <div className="admin-tab-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16, flexWrap: 'wrap', gap: 12 }}>
                <h1 style={{ fontSize: 24, fontWeight: 800, color: '#111827', letterSpacing: '-0.02em' }}>Frequencies</h1>
                <div className="admin-filter-controls" style={{ display: 'flex', gap: 12, alignItems: 'center', flexWrap: 'wrap' }}>
                  ...
                  <button onClick={() => handleAdd('frequencies')} style={{ ...buttonStyle, background: '#6366F1', color: '#fff' }}>+ Add Frequency</button>
                </div>
              </div>
              <div className="table-wrapper">
                <div style={{ background: '#fff', borderRadius: 16, border: '1px solid #E5E7EB', overflow: 'hidden' }}>
                    ...
                    <tbody>
                      {filteredFrequenciesList.map(f => (
                        <tr key={f.id} style={{ borderTop: `1px solid ${brand.border}`, opacity: f.archived ? 0.6 : 1 }}>
                          ...
                          <td style={{ padding: '16px', textAlign: 'right' }}>
                            {editingId === `frequency-${f.id}` ? (
                              <button onClick={() => handleSave('frequencies', f.id)} style={{ ...buttonStyle, background: '#6366F1', color: '#fff', marginRight: 8 }}>Save</button>
                            ) : (
                              <button onClick={() => { setEditingId(`frequency-${f.id}`); setEditValue({ name: f.name, discount_percent: f.discount_percent, interval_days: f.interval_days, sort_order: f.sort_order }); }} style={{ ...buttonStyle, background: '#EEF2FF', color: '#111827', marginRight: 8 }}>Edit</button>
                            )}
          ...
          {activeTab === 'neighborhoods' && (
            <div>
              <div className="admin-tab-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16, flexWrap: 'wrap', gap: 12 }}>
                <h1 style={{ fontSize: 24, fontWeight: 800, color: '#111827', letterSpacing: '-0.02em' }}>Neighborhoods</h1>
                <div className="admin-filter-controls" style={{ display: 'flex', gap: 12, alignItems: 'center', flexWrap: 'wrap' }}>
                  ...
                  <button onClick={() => handleAdd('neighborhoods')} style={{ ...buttonStyle, background: '#6366F1', color: '#fff' }}>+ Add Neighborhood</button>
                </div>
              </div>
              <div className="table-wrapper">
                <div style={{ background: '#fff', borderRadius: 16, border: '1px solid #E5E7EB', overflow: 'hidden' }}>
                    ...
                    <tbody>
                      {filteredNeighborhoods.map(n => (
                        <tr key={n.id} style={{ borderTop: `1px solid ${brand.border}`, opacity: n.archived ? 0.6 : 1 }}>
                          ...
                          <td style={{ padding: '16px', textAlign: 'right' }}>
                            {editingId === `neighborhood-${n.id}` ? (
                              <button onClick={() => handleSave('neighborhoods', n.id)} style={{ ...buttonStyle, background: '#6366F1', color: '#fff', marginRight: 8 }}>Save</button>
                            ) : (
                              <button onClick={() => { setEditingId(`neighborhood-${n.id}`); setEditValue({ name: n.name }); }} style={{ ...buttonStyle, background: '#EEF2FF', color: '#111827', marginRight: 8 }}>Edit</button>
                            )}
          ...
          {activeTab === 'buildings' && (
            <div>
              <div className="admin-tab-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16, flexWrap: 'wrap', gap: 12 }}>
                <h1 style={{ fontSize: 24, fontWeight: 800, color: '#111827', letterSpacing: '-0.02em' }}>Buildings</h1>
                <div className="admin-filter-controls" style={{ display: 'flex', gap: 12, alignItems: 'center', flexWrap: 'wrap' }}>
                  ...
                  <button onClick={() => handleAdd('buildings')} style={{ ...buttonStyle, background: '#6366F1', color: '#fff' }}>+ Add Building</button>
                </div>
              </div>
              <div className="table-wrapper">
                <div style={{ background: '#fff', borderRadius: 16, border: '1px solid #E5E7EB', overflow: 'hidden' }}>
                    ...
                    <tbody>
                      {filteredBuildings.map(b => (
                        <tr key={b.id} style={{ borderTop: `1px solid ${brand.border}`, opacity: b.archived ? 0.6 : 1 }}>
                          ...
                          <td style={{ padding: '16px', textAlign: 'right' }}>
                            {editingId === `building-${b.id}` ? (
                              <button onClick={() => handleSave('buildings', b.id)} style={{ ...buttonStyle, background: '#6366F1', color: '#fff', marginRight: 8 }}>Save</button>
                            ) : (
                              <button onClick={() => { setEditingId(`building-${b.id}`); setEditValue({ name: b.name, address: b.address, neighborhood_id: b.neighborhood_id }); }} style={{ ...buttonStyle, background: '#EEF2FF', color: '#111827', marginRight: 8 }}>Edit</button>
                            )}
          ...
          {activeTab === 'floorplans' && (
            <div>
              <div className="admin-tab-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16, flexWrap: 'wrap', gap: 12 }}>
                <h1 style={{ fontSize: 24, fontWeight: 800, color: '#111827', letterSpacing: '-0.02em' }}>Floor Plans</h1>
                <div className="admin-filter-controls" style={{ display: 'flex', gap: 12, alignItems: 'center', flexWrap: 'wrap' }}>
                  ...
                  <button onClick={() => handleAdd('floorplans')} style={{ ...buttonStyle, background: '#6366F1', color: '#fff' }}>+ Add Floor Plan</button>
                </div>
              </div>
              <div className="table-wrapper">
                <div style={{ background: '#fff', borderRadius: 16, border: '1px solid #E5E7EB', overflow: 'hidden' }}>
                    ...
                    <tbody>
                      {filteredFloorPlans.map(f => (
                        <tr key={f.id} style={{ borderTop: `1px solid ${brand.border}`, opacity: f.archived ? 0.6 : 1 }}>
                          ...
                          <td style={{ padding: '16px', textAlign: 'right' }}>
                            {editingId === `floorplan-${f.id}` ? (
                              <button onClick={() => handleSave('floorplans', f.id)} style={{ ...buttonStyle, background: '#6366F1', color: '#fff', marginRight: 8 }}>Save</button>
                            ) : (
                              <button onClick={() => { setEditingId(`floorplan-${f.id}`); setEditValue({ name: f.name, price: f.price, duration_minutes: f.duration_minutes || 60, building_id: f.building_id }); }} style={{ ...buttonStyle, background: '#EEF2FF', color: '#111827', marginRight: 8 }}>Edit</button>
                            )}
          ...
          {activeTab === 'unitlines' && (
            <div>
              <div className="admin-tab-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16, flexWrap: 'wrap', gap: 12 }}>
                <h1 style={{ fontSize: 24, fontWeight: 800, color: '#111827', letterSpacing: '-0.02em' }}>Unit Lines</h1>
                <div className="admin-filter-controls" style={{ display: 'flex', gap: 12, alignItems: 'center', flexWrap: 'wrap' }}>
                  ...
                  <button onClick={() => handleAdd('unitlines')} style={{ ...buttonStyle, background: '#6366F1', color: '#fff' }}>+ Add Unit Line</button>
                </div>
              </div>
              <div className="table-wrapper">
                <div style={{ background: '#fff', borderRadius: 16, border: '1px solid #E5E7EB', overflow: 'hidden' }}>
                      ...
                      {filteredUnitLines.map(ul => {
                        ...
                        return (
                          <tr key={ul.id} style={{ borderTop: `1px solid ${brand.border}`, opacity: ul.archived ? 0.6 : 1 }}>
                            ...
                            <td style={{ padding: '16px', textAlign: 'right' }}>
                              {isEditing ? (
                                <button onClick={() => handleSave('unitlines', ul.id)} style={{ ...buttonStyle, background: '#6366F1', color: '#fff', marginRight: 8 }}>Save</button>
                              ) : (
                                <button onClick={() => { setEditingId(`unitline-${ul.id}`); setEditValue({ building_id: ul.building_id, line_number: ul.line_number, floor_min: ul.floor_min, floor_max: ul.floor_max, floor_plan_id: ul.floor_plan_id || '', custom_price: ul.custom_price ?? '' }); }} style={{ ...buttonStyle, background: '#EEF2FF', color: '#111827', marginRight: 8 }}>Edit</button>
                              )}
          ...
          {activeTab === 'addons' && (
            <div>
              <div className="admin-tab-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16, flexWrap: 'wrap', gap: 12 }}>
                <h1 style={{ fontSize: 24, fontWeight: 800, color: '#111827', letterSpacing: '-0.02em' }}>Add-Ons</h1>
                <div className="admin-filter-controls" style={{ display: 'flex', gap: 12, alignItems: 'center', flexWrap: 'wrap' }}>
                  ...
                  <button onClick={() => handleAdd('addons')} style={{ ...buttonStyle, background: '#6366F1', color: '#fff' }}>+ Add Add-On</button>
                </div>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 20px', borderRadius: 16, border: '1px solid #E5E7EB', background: '#F9FAFB', marginBottom: 16 }}>
                <div>
                    ...
                    <tbody>
                      {filteredAddOnsList.map(a => (
                        <tr key={a.id} style={{ borderTop: `1px solid ${brand.border}`, opacity: a.archived ? 0.6 : 1 }}>
                          ...
                          <td style={{ padding: '16px', textAlign: 'right' }}>
                            {editingId === `addon-${a.id}` ? (
                              <button onClick={() => handleSave('addons', a.id)} style={{ ...buttonStyle, background: '#6366F1', color: '#fff', marginRight: 8 }}>Save</button>
                            ) : (
                              <button onClick={() => { setEditingId(`addon-${a.id}`); setEditValue({ name: a.name, price: a.price }); }} style={{ ...buttonStyle, background: '#EEF2FF', color: '#111827', marginRight: 8 }}>Edit</button>
                            )}
          ...
          {activeTab === 'workers' && (
            <div>
              <div className="admin-tab-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16, flexWrap: 'wrap', gap: 12 }}>
                <h1 style={{ fontSize: 24, fontWeight: 800, color: '#111827', letterSpacing: '-0.02em' }}>Workers</h1>
                <div className="admin-filter-controls" style={{ display: 'flex', gap: 12, alignItems: 'center', flexWrap: 'wrap' }}>
                  ...
                  <button onClick={() => handleAdd('workers')} style={{ ...buttonStyle, background: '#6366F1', color: '#fff' }}>+ Add Worker</button>
                </div>
              </div>
              <div className="table-wrapper">
                <div style={{ background: '#fff', borderRadius: 16, border: '1px solid #E5E7EB', overflow: 'hidden' }}>
                    ...
                    <tbody>
                      {filteredWorkers.map(w => (
                        <tr key={w.id} style={{ borderTop: `1px solid ${brand.border}`, opacity: w.archived ? 0.6 : 1 }}>
                          ...
                          <td style={{ padding: '16px', textAlign: 'right' }}>
                            {editingId === `worker-${w.id}` ? (
                              <button onClick={() => handleSave('workers', w.id)} style={{ ...buttonStyle, background: '#6366F1', color: '#fff', marginRight: 8 }}>Save</button>
                            ) : (
                              <button onClick={() => { setEditingId(`worker-${w.id}`); setEditValue({ name: w.name, email: w.email, phone: w.phone }); }} style={{ ...buttonStyle, background: '#EEF2FF', color: '#111827', marginRight: 8 }}>Edit</button>
                            )}
          ...
          {activeTab === 'availability' && (
            <div>
              <h1 style={{ fontSize: 24, fontWeight: 800, color: '#111827', letterSpacing: '-0.02em', marginBottom: 20 }}>Availability</h1>

              {/* Sub-tab navigation */}
              <div style={{ display: 'inline-flex', gap: 4, marginBottom: 28, background: '#EEF2FF', borderRadius: 12, padding: 4 }}>
                {[
                  ...
                  <button
                    ...
                    style={{
                      ...
                      color: availabilitySubTab === tab.id ? '#fff' : '#6B7280',
                      background: availabilitySubTab === tab.id ? '#6366F1' : 'transparent',
                  ...
                  {!selectedWorkerAvail ? (
                    <div>
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                        {workers.map(w => {
                          ...
                          return (
                            <div
                              ...
                              style={{
                                background: '#fff', borderRadius: 16, border: '1px solid #E5E7EB', padding: '16px 20px',
                        ...
                        {workers.length === 0 && (
                          <div style={{ padding: 32, textAlign: 'center', color: brand.textLight, background: '#fff', borderRadius: 16, border: '1px solid #E5E7EB' }}>
                    ...
                    <div>
                      ...
                      <div style={{ display: 'flex', gap: 8, marginTop: 16 }}>
                        <button
                          ...
                          style={{ ...buttonStyle, background: '#6366F1', color: '#fff', opacity: availSaving ? 0.6 : 1 }}
                        >
                          {availSaving ? 'Saving...' : 'Save Schedule'}
                        </button>
                        <button
                          onClick={() => { setSelectedWorkerAvail(''); setEditingAvailability(null); }}
                          style={{ ...buttonStyle, background: '#EEF2FF', color: '#111827' }}
                        >
                          Cancel
                        </button>
                      </div>
                  ...
                  <div style={{ display: 'flex', gap: 24, flexWrap: 'wrap' }}>
                    ...
                    <div style={{ flex: '1 1 400px', minWidth: 320 }}>
                      ...
                      <div style={{ background: '#fff', borderRadius: 16, border: '1px solid #E5E7EB', padding: 16, marginBottom: 16 }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
                          <button onClick={() => { if (calendarMonth === 0) { setCalendarMonth(11); setCalendarYear(calendarYear - 1); } else setCalendarMonth(calendarMonth - 1); }} style={{ ...buttonStyle, background: '#EEF2FF', color: '#111827', padding: '6px 14px' }}>&lt;</button>
                          <span style={{ fontSize: 16, fontWeight: 600, color: brand.text }}>{MONTH_NAMES[calendarMonth]} {calendarYear}</span>
                          <button onClick={() => { if (calendarMonth === 11) { setCalendarMonth(0); setCalendarYear(calendarYear + 1); } else setCalendarMonth(calendarMonth + 1); }} style={{ ...buttonStyle, background: '#EEF2FF', color: '#111827', padding: '6px 14px' }}>&gt;</button>
                        </div>
              ...
              {availabilitySubTab === 'overrides' && (
                <div>
                  ...
                  <div style={{ background: '#fff', borderRadius: 16, border: '1px solid #E5E7EB', padding: 24, marginBottom: 24 }}>
                    ...
                    <button onClick={handleAddOverride} style={{ ...buttonStyle, background: '#6366F1', color: '#fff', marginTop: 16 }}>
                      + Add Override
                    </button>
                  </div>
          ...
          {activeTab === 'settings' && (
            <div>
              <h1 style={{ fontSize: 24, fontWeight: 800, color: '#111827', letterSpacing: '-0.02em', marginBottom: 24 }}>Settings</h1>
              <div style={{ background: '#fff', borderRadius: 16, border: '1px solid #E5E7EB', padding: 24, maxWidth: 600 }}>
                ...
                <div style={{ marginTop: 20, display: 'flex', gap: 8 }}>
                  <button
                    ...
                    style={{ ...buttonStyle, background: '#6366F1', color: '#fff', opacity: (availSaving || !editingSettings) ? 0.6 : 1 }}
                  >
                    {availSaving ? 'Saving...' : 'Save Settings'}
                  </button>
                  {editingSettings && (
                    <button onClick={() => setEditingSettings(null)} style={{ ...buttonStyle, background: '#EEF2FF', color: '#111827' }}>
                      Cancel
                    </button>
                  )}
                </div>

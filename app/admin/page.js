...
export default function AdminPanel() {
  ...
  const tabs = [
    ...
    { id: 'frequencies', label: 'Frequencies', icon: '\u{1F504}' },
    { id: 'neighborhoods', label: 'Neighborhoods', icon: '\u{1F3D8}\uFE0F' },
    { id: 'buildings', label: 'Buildings', icon: '\u{1F3E2}' },
    { id: 'floorplans', label: 'Floor Plans', icon: '\u{1F4D0}' },
    { id: 'unitlines', label: 'Unit Lines', icon: '\u{1F4CF}' },
